                    ...
                    <div id="kt_app_toolbar_container" class="app-container  container-fluid d-flex align-items-stretch ">
                        ...
                        <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                            ...
                            <div class="d-flex align-items-center gap-2 gap-lg-3">
                                <a href="<?=site_url('Employee/concerns')?>" class="btn btn-sm btn-flex btn-primary">
                            ...
                            <div class="col-lg-8">
                                <div class="card card-flush py-4">
                                    <div class="card-header">
                                        <div class="card-title"><i class="fa-solid fa-pen-to-square"></i>&nbsp;Write</div>
                                    </div>
                                    <div class="card-body pt-0">
                                        <form method="POST" class="form w-100" id="frmConcern">
                                            ...
                                            <div class="fv-row mb-4">
                                                ...
                                                <textarea id="address" class="form-control" name="details" class="mb-2" style="height:200px;"></textarea>
                                            </div>
                                            <div class="fv-row mb-4" id="btnConfirm">
                                                <button type="submit" class="btn btn-primary" id="Add"><i class="fa-regular fa-paper-plane"></i>&nbsp;Submit</button>
                                            </div>
	    ...
	    <!--end::Javascript-->
            <script>
                $('#frmConcern').on('submit',function(e){
                    ...
                    $.ajax({
                        url:"<?=site_url('create')?>",method:"POST",
                        data:data,
