...
<html lang="en" >
    <!--begin::Head-->
    <head>
        <title>E201 - Edit Employee</title>
        <meta charset="utf-8"/>
                    ...
                    <div class="app-header-secondary-menu-main d-flex flex-grow-lg-1 align-items-end pt-3 pt-lg-2 px-3 px-lg-0 w-auto overflow-auto flex-nowrap">
                        <div class="app-container  container-fluid ">
                            ...
                            >        
                                ...
                                <div  class="menu-item " >
                                    <!--begin:Menu link-->
                                    <a class="menu-link active"  href="javascript:void(0);"><span  class="menu-title" >Edit Employee</span></a>
                                    <!--end:Menu link-->
                                </div><!--end:Menu item-->
                                <!--begin:Menu item-->
                                <div  class="menu-item" >
                    ...
                    <div id="kt_app_toolbar_container" class="app-container  container-fluid d-flex align-items-stretch ">
                        ...
                        <div class="app-toolbar-wrapper d-flex flex-stack flex-wrap gap-4 w-100">
                            ...
                            <div class="d-flex align-items-center gap-2 gap-lg-3">
                                <a href="<?=site_url('HR/view/')?><?php echo $employee['Token'] ?>" class="btn btn-sm btn-flex btn-primary">
                                                    ...
                                                    <div class="fv-row mb-4">
                                                        <div class="d-flex flex-wrap gap-5">
                                                            ...
                                                            <div class="fv-row w-100 flex-md-root">
                                                                ...
                                                                <input type="phone" name="contactNo" id="contactNo" value="<?php echo $employee['ContactNo'] ?>" maxlength="11" minlength="11" name="phone" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*?)\..*/g, '$1');" class="form-control bg-transparent"/> 
                                                        ...
                                                        <div class="d-flex flex-wrap gap-5">
                                                            ...
                                                            <div class="fv-row w-100 flex-md-root">
                                                                ...
                                                                <select class="form-select mb-2" data-control="select2" name="gender" id="gender">
                                                                    <option value="">Choose</option>
                                                                    <option <?php if($employee['Gender']=="Male") echo 'selected="selected"'; ?>>Male</option>
                                                                    <option <?php if($employee['Gender']=="Female") echo 'selected="selected"'; ?>>Female</option>
                                                                </select>   
